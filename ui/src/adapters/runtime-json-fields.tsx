...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label={t("padapters_runtime-json-fields.runtime_services_json", {defaultValue: "Runtime services JSON"})} hint={help.runtimeServicesJson}>
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field label={t("padapters_runtime-json-fields.payload_template_json", {defaultValue: "Payload template JSON"})} hint={help.payloadTemplateJson}>
      <textarea
