  ...
  return (
    <div className="flex items-center w-full">
      <Button
        ...
        aria-label={t("ppages_IssueDetail.back_to_inbox", {defaultValue: "Back to inbox"})}
      >
      ...
      <div className="ml-auto flex items-center gap-0.5">
        {issueIdProp && !issueHidden && (
          <Button
            ...
            aria-label={t("ppages_IssueDetail.archive_from_inbox", {defaultValue: "Archive from inbox"})}
          >
        ...
        <Popover open={menuOpen} onOpenChange={setMenuOpen}>
          <PopoverTrigger asChild>
            <Button variant="ghost" size="icon-sm" aria-label={t("ppages_IssueDetail.more_actions", {defaultValue: "More actions"})}>
    ...
    <>
      {shouldShowCostSummary && (
        <div className="mb-3 px-3 py-2 rounded-lg border border-border">
          <div className="text-sm font-medium text-muted-foreground mb-1">{t("ppages_IssueDetail.cost_summary", {defaultValue: "Cost Summary"})}</div>
          {!issueCostSummary.hasCost && !issueCostSummary.hasTokens && !hasIssueTreeCost ? (
            <div className="text-xs text-muted-foreground">{t("ppages_IssueDetail.no_cost_data_yet", {defaultValue: "No cost data yet."})}</div>
          ) : (
            <div className="space-y-1 text-xs text-muted-foreground tabular-nums">
              <div className="flex flex-wrap gap-3">
                <span className="font-medium text-foreground">{t("ppages_IssueDetail.this_issue", {defaultValue: "This issue"})}</span>
                ...
                {!issueCostSummary.hasCost && !issueCostSummary.hasTokens && !issueCostSummary.hasRuntime ? (
                  <span>{t("ppages_IssueDetail.no_direct_cost_data", {defaultValue: "No direct cost data."})}</span>
                ) : null}
              </div>
    ...
    <>
      ...
      >
        ...
        {uploadAttachment.isPending || importMarkdownDocument.isPending ? "Uploading..." : (
          <>
            <span className="hidden sm:inline">{t("ppages_IssueDetail.upload_attachment", {defaultValue: "Upload attachment"})}</span>
            <span className="sm:hidden">{t("ppages_IssueDetail.upload", {defaultValue: "Upload"})}</span>
          </>
        )}
      </Button>
    </>
    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 min-w-0 flex-wrap">
          ...
          {issue.originKind === "issue_productivity_review" ? (
            <span
              ...
              title={t("ppages_IssueDetail.this_task_is_a_productivity_review", {defaultValue: "This task is a productivity review."})}
            >
          ...
          {issue.workMode === "planning" ? (
            <span
              ...
              title={t("ppages_IssueDetail.this_issue_is_in_planning_mode", {defaultValue: "This issue is in planning mode."})}
            >
              Planning
            </span>
          ) : null}
          ...
          {hasAssignedBacklogBlocker(issue.blockedBy) ? (
            <span
              ...
              title={t("ppages_IssueDetail.blocked_by_parked_work_at_least_one_assigned_block", {defaultValue: "Blocked by parked work — at least one assigned blocker is in backlog and will not wake its assignee."})}
            >
          ...
          {!(isMobile && isFromInbox) && (
            <div className="ml-auto flex items-center gap-0.5 md:hidden shrink-0">
              <Button
                ...
                title={t("ppages_IssueDetail.copy_issue_as_markdown", {defaultValue: "Copy issue as markdown"})}
              >
              ...
              <Button
                ...
                title={t("ppages_IssueDetail.properties", {defaultValue: "Properties"})}
              >
          ...
          <div className="hidden md:flex items-center md:ml-auto shrink-0">
            {canArchiveFromInbox && (
              <Button
                ...
                disabled={archivePending}
                title={t("ppages_IssueDetail.archive_from_inbox", {defaultValue: "Archive from inbox"})}
                aria-label={t("ppages_IssueDetail.archive_from_inbox", {defaultValue: "Archive from inbox"})}
              >
            ...
            <Button
              ...
              title={t("ppages_IssueDetail.show_properties", {defaultValue: "Show properties"})}
            >
              <SlidersHorizontal className="h-4 w-4" />
            </Button>
            ...
            <Popover open={moreOpen} onOpenChange={setMoreOpen}>
              <PopoverTrigger asChild>
                <Button
                  ...
                  size="icon-xs"
                  className="shrink-0"
                  aria-label={t("ppages_IssueDetail.more_issue_actions", {defaultValue: "More issue actions"})}
                  title={t("ppages_IssueDetail.more_issue_actions", {defaultValue: "More issue actions"})}
                  onKeyDown={(event) => {
        ...
        <InlineEditor
          ...
          placeholder={t("ppages_IssueDetail.add_a_description", {defaultValue: "Add a description..."})}
          multiline
          foldable
      ...
      {showRichSubIssuesSection ? (
        <div className="space-y-3">
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-sm font-medium text-muted-foreground">{t("ppages_IssueDetail.subissues", {defaultValue: "Sub-issues"})}</h3>
          </div>
          <IssuesList
            issues={childIssues}
      ...
      >
        <div className="flex items-center justify-between gap-2">
          <h3 className="text-sm font-medium text-muted-foreground">{t("ppages_IssueDetail.attachments", {defaultValue: "Attachments"})}</h3>
            ...
            {imageAttachments.map((attachment) => (
              ...
              >
                ...
                {confirmDeleteId === attachment.id ? (
                  ...
                  >
                    <p className="text-xs text-white font-medium">{t("ppages_IssueDetail.delete", {defaultValue: "Delete?"})}</p>
                  ...
                  <button
                    ...
                    title={t("ppages_IssueDetail.delete_attachment", {defaultValue: "Delete attachment"})}
                  >
          ...
          <div className="min-h-0 flex-1 space-y-4 overflow-y-auto overscroll-contain px-6 py-4">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                placeholder={t("ppages_IssueDetail.explain_why_this_subtree_control_is_being_applied", {defaultValue: "Explain why this subtree control is being applied..."})}
            ...
            <div className="space-y-2">
              {treeControlPreviewLoading ? (
                        ...
                        <div key={candidate.id} style={candidate.depth > 0 ? { paddingLeft: `${Math.min(candidate.depth, 6) * 14}px` } : undefined}>
                          ...
                          >
                            ...
                            {candidate.skipped && candidate.skipReason === "terminal_status" ? (
                              <span className="shrink-0 text-xs text-muted-foreground">{t("ppages_IssueDetail.complete", {defaultValue: "Complete"})}</span>
                            ) : null}
                          </Link>
                        </div>
                      ))}
                ...
                <p className="text-xs text-muted-foreground">{t("ppages_IssueDetail.preview_unavailable", {defaultValue: "Preview unavailable."})}</p>
              )}
            </div>
          </div>
      ...
      <Sheet open={mobilePropsOpen} onOpenChange={setMobilePropsOpen}>
        <SheetContent side="bottom" className="max-h-[85dvh] pb-[env(safe-area-inset-bottom)]">
          <SheetHeader>
            <SheetTitle className="text-sm">{t("ppages_IssueDetail.properties", {defaultValue: "Properties"})}</SheetTitle>
          </SheetHeader>
