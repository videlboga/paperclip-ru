    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        ...
        {showCloseButton && (
          ...
          >
            <XIcon />
            <span className="sr-only">{t("pcomponents/ui_dialog.close", {defaultValue: "Close"})}</span>
          </DialogPrimitive.Close>
        )}
      </DialogPrimitive.Content>
    </DialogPortal>
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close asChild>
          <Button variant="outline">{t("pcomponents/ui_dialog.close", {defaultValue: "Close"})}</Button>
        </DialogPrimitive.Close>
      )}
    </div>
  )
